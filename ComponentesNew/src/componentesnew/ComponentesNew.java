...
public class ComponentesNew extends JFrame{
    ...
    public void AddComponentes(JPanel panel1){
        //setBounds(X,Y,ancho, alto);  Recibe 4 parametros, recuerda que el parametro ancho y alto son datos en pixeles 
        ...
        radio1.setText("Radio 1"); // configuramos el valor de radio mediante el metodo setText
        panel1.add(radio1);
        ...
        check1.setBounds(10, 155, 80, 30);
        check1.setText("Check 1");
        panel1.add(check1);
        check2.setBounds(100, 155, 80, 30);
        check2.setText("Check 2");
        panel1.add(check2);
        
        //ComboBox o lista desplegable 
        combolista.setBounds(10, 190, 100, 20); 
